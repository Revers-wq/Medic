...
public class ExampleUnitTest {
    ...
    public void fillQueaeTest() {
        ...
        int[] imagId={R.drawable.screen2,R.drawable.screen2, R.drawable.screen3};
        SwitchScreen switchScreen = new SwitchScreen();
        for(int i =0; i< mainText.length;i++)
        {
                Assert.assertArrayEquals(new String[]{mainText[i], text[i], ""+imagId[i]}, switchScreen.FillQueae(i));
        }
    }
    @Test
    public void getQueaeTest() {
        ...
        for(int i =0; i< mainText.length;i++)
        {
            Assert.assertArrayEquals(new String[]{mainText[i], text[i], ""+imagId[i]}, switchScreen.getQueae(i));
        }
    }
    @Test
    ...
    public void getFinis() {
        Assert.assertEquals(true,SessionManager.saveFinishActivity(0));
    }
}
